...
namespace PizzaPlaceApi.Api.Controllers
{
    ...
    public class PizzaController : Controller
    {
        ...
        public PizzaController(IPizzaService pizzaService, IPizzaTypeService pizzaTypeService, ILogger<PizzaController> logger)
        {
        ...
        public async Task<ActionResult<Pizza>> CreatePizza(Pizza pizza)
        {
            ...
            {
                _logger.LogError($"Something went wrong while creating Pizza: {pizza.PizzaId}. {ex}");
                return StatusCode(500, $"Something went wrong while creating Pizza: {pizza.PizzaId}. {ex}");
            }   
        }
